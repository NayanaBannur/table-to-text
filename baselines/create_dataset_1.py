...
train_size_per_rule = [500, 500, 500]
dev_size_per_rule = [50, 50, 50]
test_size_per_rule = [50, 50, 50]
...
def rows_comp(datum):
    ...
    if first < second:
        datum["text"] = f"{second_rh} is greater than {first_rh} given {col_name}"
    else:
        datum["text"] = f"{first_rh} is greater than {second_rh} given {col_name}"
